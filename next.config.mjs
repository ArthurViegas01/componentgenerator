...
const nextConfig = {
  ...
  // Ao rodar `next dev --turbopack`, a config abaixo vazia silencia o warning
  // "using Turbopack with a webpack config" — na prática os defaults do
  // Turbopack já resolvem o que precisamos (Monaco + fonts).
  turbopack: {},
