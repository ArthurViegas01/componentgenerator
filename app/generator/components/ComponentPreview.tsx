...
try {
  ...
  const safeProps = new Proxy(__mockProps, {
    get(target, key) {
      ...
      // Unknown prop: return an empty string that won't crash .map/.length
      // on primitive reads. Function-typed props callers will see undefined,
      // which is fine — we can't know the signature.
      return undefined;
    },
  });
